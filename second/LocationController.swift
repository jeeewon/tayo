...
class LocationController: UIViewController, CLLocationManagerDelegate {
    ...
    @IBAction func noButton(_ sender: Any) {
        guard let no = self.storyboard?.instantiateViewController(withIdentifier: "Location") else {return}
    ...
    @IBAction func reverseButton(_ sender: Any) {
        self.performSegue(withIdentifier: "Reverse", sender: nil)
    }
